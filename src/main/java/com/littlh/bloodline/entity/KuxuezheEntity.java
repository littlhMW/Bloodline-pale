...
public class KuxuezheEntity extends Monster implements GeoEntity {
    ...
    private void summonMinions() {
        ...
        for (int i = 0; i < count; i++) {
            PaleMinionEntity minion = BloodlineEntities.PALE_MINION.get().create(this.level());
            if (minion != null) {
    ...
    private static class BossCombatGoal extends Goal {
        ...
        public BossCombatGoal(KuxuezheEntity boss) { this.boss = boss; this.setFlags(EnumSet.of(Flag.MOVE, Flag.LOOK)); }
