...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(Registries.SOUND_EVENT, "pale_lullaby");
            ...
            try (Reader reader = new InputStreamReader(
                ...
                for (JsonElement elem : array) {
                    ...
                    Supplier<SoundEvent> supplier = SOUND_EVENTS.register(eventId,
                            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.parse("pale_lullaby:" + eventId)));
    ...
    public static List<ResourceLocation> getMusicTrackLocations() {
        ...
        for (String name : MUSIC_TRACK_NAMES) {
            locations.add(ResourceLocation.parse("pale_lullaby:pale_cradle_music." + name));
        }
        return locations;
    }
